...
mali_dvfs_table mali_dvfs[MALI_DVFS_STEPS]={
			...
			/* step 1 */{533  ,1000000	,1100000   ,95   ,100} };
#endif
...
static unsigned int asv_3d_volt_9_table_1ghz_type[MALI_DVFS_STEPS-1][ASV_LEVEL] = {
	...
	{ 1075000, 1100000, 1100000, 1100000, 1000000, 1000000, 1000000,  975000,  975000,  975000,  975000,  925000},  /* L1(350Mhz) */
...
#if (MALI_DVFS_STEPS > 2)
	{ 1100000, 1025000, 1000000, 1000000,  975000,  950000,  950000,  950000,  925000,  925000,  925000,  900000},  /* L1(350Mhz) */
#if (MALI_DVFS_STEPS > 3)
	{ 1100000, 1075000, 1100000, 1100000, 1100000, 1025000, 1025000, 1000000, 1000000, 1000000,  975000,  950000},  /* L0(440Mhz) */
#endif
#endif
#endif
};
...
#if (MALI_DVFS_STEPS > 3)
	{ 1087500, 1075000, 1062500, 1100000, 1037500, 1025000, 1012500, 1000000, 1012500, 1000000,  975000,  962500,  950000},	/* L1(440Mhz) */
...
#if (MALI_DVFS_STEPS > 3)
	{ 1100000, 1075000, 1100000, 1100000, 1100000, 1100000, 1025000, 1000000, 1000000,  975000,  975000,  950000, 925000},	/* L0(440Mhz) */
#endif
#endif
#endif
};
